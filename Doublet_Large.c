...
void Initialization(int WildTypeVector[], int MutantVector[], int InitialNumberOfWildTypes, int InitialNumberOfMutants, double *Time)
{
	...
	MutantVector[0] = InitialNumberOfMutants;
	MutantVector[1] = 0;	
	*Time = 0;
}
...
int main()
{
	...
	const int LargeCarryingCapacity = 400, SmallCarryingCapacity = 100, InitialNumberOfWildTypes = 90, InitialNumberOfMutants = 360, NumberOfDemes = 2, NumberOfRealizations = 1000;
